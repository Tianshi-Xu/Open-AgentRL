        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    print(f"Generation time: {time.perf_counter() - time_start:.2f} seconds")
                    time_start = time.perf_counter()
                    ...
                    print(f"Batch preparation time: {time.perf_counter() - time_start:.2f} seconds")
                    time_start = time.perf_counter()
                    ...
                    print(f"Reward computation time: {time.perf_counter() - time_start:.2f} seconds")
                    time_start = time.perf_counter()
                    ...
                    print(f"Rollout correction time: {time.perf_counter() - time_start:.2f} seconds")
                    time_start = time.perf_counter()
                    ...
                    print(f"Advantage computation time: {time.perf_counter() - time_start:.2f} seconds")
                    time_start = time.perf_counter()
                    ...
                    print(f"Model update time: {time.perf_counter() - time_start:.2f} seconds")
                # validate
                if (
